...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalLayoutWidget_3->setGeometry(QRect(-1, 179, 351, 341));
        verticalLayout_stat = new QVBoxLayout(verticalLayoutWidget_3);
        verticalLayout_stat->setObjectName(QStringLiteral("verticalLayout_stat"));
        verticalLayout_stat->setContentsMargins(0, 0, 0, 0);
